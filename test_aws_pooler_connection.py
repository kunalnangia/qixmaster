...
def test_connection():
    # Connection string with AWS pooler endpoint
    db_url = "postgresql://postgres.lflecyuvttemfoyixngi:Ayeshaayesha12@@aws-0-ap-southeast-1.pooler.supabase.com:5432/postgres"
    ...
    try:
        ...
        print(f"\n✅ Successfully connected to PostgreSQL {version[0]}")
